...
import net.svichch.geekbrains.maps.GoogleMapUtil.Companion.positionToRotation
import net.svichch.geekbrains.maps.MainActivity
import net.svichch.geekbrains.maps.R

class GamesCar(private val googleMap: GoogleMap, private val mainActivity: MainActivity) :
        ...
        markerCar = googleMap
            .addMarker(
                MarkerOptions()
                    ...
                    .icon(BitmapDescriptorFactory.fromBitmap(car.getImageCar())) // Цвет маркера
                    .draggable(false) // Перетаскиваемость
                    .anchor(0.5f, 0.5f)  //якорь - будет вращаться вокруг своего центра
                    .rotation(90.0f)
